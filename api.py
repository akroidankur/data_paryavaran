...
async def fetch_aqi_data():
    ...
    return await fetch_data_async(url, "AQI")

async def fetch_emissions_data():
    url = f"https://api.data.gov.in/resource/38af56a8-1abb-44ad-b83d-cce79168fd4e?api-key={API_KEY}&format=json&limit=100"
    return await fetch_data_async(url, "Emissions")